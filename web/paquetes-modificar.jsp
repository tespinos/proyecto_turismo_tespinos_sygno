  ...
  <body>
	...
	<div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            ...
            <h2 class="mb-4">Modificar paquete</h2>

            <form action="SvModificarPaqueteTuristico" class="edit-form" method="GET">
                <%

                    PaqueteTuristico paquete = (PaqueteTuristico) miSesion.getAttribute("paqueteTuristico");
                    {
                %>
                <div class="form-row">
                        ...
                        <div class="row">
                          <legend class="col-form-label col-sm-2 pt-0">Servicios:</legend>
                            ...
                            <%
                                ...
                                List<ServicioTuristico> todosLosServicios = control.traerServiciosTuristicos();
                                for (ServicioTuristico servicio : todosLosServicios) {                                    
                            %>
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="number" class="form-control" id="costo" name="costo" value="<%=paquete.getCosto_paquete()%>" readonly>
                    </div>
                </div>
